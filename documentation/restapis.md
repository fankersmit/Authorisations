...
|:---:|:---:|:---:|:---|:---:|:---:|:---:|---|
|<span style="color:green">Yes</span>|RPC|Q|root/ping|GET| 200 | 404| returns { status: "up" }|
|<span style="color:green">Yes</span>|RPC|Q|root/request/{id}/status |GET| 200|404| returns current status of request with {id}|
|<span style="color:green">Yes</span>|RPC|Q|root/request/{id}/status/{status} |GET|200|404| returns true if status of request with {id} is {status}
|<span style="color:green">Yes</span>|RPC|Q|root/requests/under-consideration/count |GET| 200|404| return total number of requests being processed
|<span style="color:green">Yes</span>|RPC|Q|root/requests/under-consideration/{type}/count |GET| 200 |404 | return total number of account requests of {type }being processed
|<span style="color:green">Yes</span>|RPC|Q|root/requests/{status} |GET| 200|404| returns ID of all requests with status = {status}
|<span style="color:red">No</span>|RPC|Q|root/requests/{status}/{type} |GET| 200|404| returns ID of all requests of {type} with status = {status}}
|<span style="color:green">Yes</span>|RPC|Q|root/request/{id}|GET| 200|404| returns current request info where ID = {id}
|<span style="color:green">Yes</span>|REST|C|root/request/submit/|POST| 202|404,405| submit request where type is in {account, product, organisation}
